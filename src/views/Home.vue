<template>
    ...
    >
        ...
        >
            <div class="up">
                <div
                    class="w-full h-2/3 flex flex-col justify-end items-center"
                >
                    <p
                    ...
                    >
                        ...
                        <span
                            class="star inline-block bg-fer p-2 rounded-md text-white"
                        >
                ...
                <div class="w-full h-1/3">
                    <div class="loader1" v-if="searching === true">
                        Loading...
                    </div>
                </div>
            </div>
            ...
            <div class="down grid gap-2 grid-cols-1 sm:grid-cols-2 pr-2">
                <div class="history px-2 pb-12 overflow-hidden">
                    <p
                        class="title mb-2 text-center font-bold text-2xl underline"
                    >
                        History
                    </p>
                    <div
        ...
        >
            ...
            >
                ...
                <span class="per-page-text"
                    >Enter number between 1 and {{ totalPages }} then press
                    Enter or Send</span
                >
            </div>
            ...
            >
                ...
                <p class="text-3xl md:text-6xl font-bold text-fer">
                    No Result Found
                </p>
            </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="others flex justify-between">
                                <div class="year">
                                    {{ movie.Year | truncateYear }}
                                </div>
                                <div class="group text-fer">
                                    {{ movie.Rated }}
                                </div>
                                <div class="rate">
                                    <font-awesome-icon
            ...
            <transition name="fly-in" appear>
                <div
                    ...
                    v-if="
                        this.nominations.length >= 5 && fullNomination === true
                    "
                >
                    <div
                    ...
                    >
                        <p class="font-black text-lg sm:text-3xl">
            ...
            <div class="w-full h-full">
                <div
                    ...
                    v-if="searching === true"
                >
                    <div class="loader2 flex place-items-center">
                        Loading...
                    </div>
                </div>
                <div
                ...
                >
                    ...
                    >
                        <div
                            class="movie-image w-full h-52 relative md:h-64 rounded-xl"
                        >
                            <img
                                :src="movie.Poster"
                ...
                try {
                    ...
                    if ([200, 201].includes(response.status)) {
                        ...
                        if (items.length === 0) {
                            ...
                            this.showWarning(
                                `Zero (0) results found for ${searchTerm}.`,
                            )
                            return
                        }
